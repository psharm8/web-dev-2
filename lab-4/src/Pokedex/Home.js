        ...
        return (
            <div>
                <Panel header="Pokémon" bsStyle="primary">
                    ...
                    <p><Link className="btn btn-primary" to={'/pokemon/page/0'}>More...</Link></p>
                </Panel>
                <Panel header="Berries" bsStyle="primary">
                    ...
                    <p><Link className="btn btn-primary" to={'/berries/page/0'}>More...</Link></p>
                </Panel>
                <Panel header="Machines" bsStyle="primary">
                    <p>Machines are the representation of items that teach moves to Pokémon. They vary from version
                        ...
                        Machine.</p>
                    <p><Link className="btn btn-primary" to={'/machines/page/0'}>More...</Link></p>
                </Panel>
            </div>
        );
    }
